...
- Q: 빈칸찾기 문제 (depth ?)
    ...
    자바로 애플리케이션을 쉽게 만들수 있게 도와주는것은 ??? 이고 만들어진 "웹 어플리케이션"의 실행 환경을 제공해주는게 xxx 입니다.  만약 자바 어플리케이션이 웹 어플리케이션이 아니라면 xxx 은 필요가 없고,  웹 어플리케이션이라면 그 xxx은 ooo에서 돌아가고 ooo은 호스트 OS에서 돌아가게 됩니다.
...
## spring-boot-starter와 spring-boot-starter-web의 차이점에 대해 말씀해주세요.
    ...
    ***Starter***는 특정 목적을 달성하기 위한 의존성 그룹입니다.
    ...
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/d2438c27-2166-4ea2-a50c-93d97c48776f/71fe745d-56ec-4ae3-a708-9ab50a9420fe/Untitled.png)
    ...
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/d2438c27-2166-4ea2-a50c-93d97c48776f/575c9f46-7c1f-4432-befb-c9a030a618be/Untitled.png)
...
## Spring Boot에서 Tomcat 대신 다른 서버를 사용하고 싶다면 어떻게 해야 하나요?
    ...
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/d2438c27-2166-4ea2-a50c-93d97c48776f/86d04e12-ff66-4b82-b95e-b96c675bc7a8/Untitled.png)
    
    애플리케이션을 실행해보면 콘솔에 해당 웹 서버가 실행되었다는 내용을 확인할 수 있습니다.
    
    ![Untitled](https://prod-files-secure.s3.us-west-2.amazonaws.com/d2438c27-2166-4ea2-a50c-93d97c48776f/204ca5d6-e19a-4309-af8b-fed7eebc2cb2/Untitled.png)
    
    - Jetty, Netty gradle 의존 표성 추가
...
## @Controller와 @RestController의 차이점에 대해 말씀해주세요.
    ...
    - `@Controller`는 주로 View를 반환하기 위해 사용합니다. Controller가 요청을 처리 후 반환한 viewName을 **viewResolver**를 통해 viewName에 해당하는 view를 찾아 렌더링합니다.
...
## Spring Boot의 장점과 특징에 대해 말씀해주세요.


    1. **자주 사용되는 라이브러리들의 버전 관리 자동화**
        - Spring Boot는 'Starter' 종속성을 사용하여 자주 사용되는 라이브러리들의 버전을 자동으로 관리합니다.
